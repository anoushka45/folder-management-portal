                ...
                <div class="main-panel fade-in">
                    ...
                    <?php else: ?>
                        ...
                        <form id="mediaForm" method="post"
                            action="../admin/process_selected_images_admin.php?event_id=<?php echo $eventId; ?>">
                                ...
                                <?php if ($numImages > 0): ?>
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="button-group d-none d-md-flex">
                                            <button type="submit" name="download_images" class="btn icon-btn p-2 mx-2">
                                    ...
                                    <div class="grid-container mt-2" id="media-container">
                                        ...
                                        AND  file_type = 'photo'  AND approval_status = 'approved'";
                            ...
                            <div id="videoSection" class="media-section"
                                ...
                                <?php if ($numVideos > 0): ?>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <div class="button-group d-none d-md-flex">
                                            <button type="submit" name="download_videos" class="btn icon-btn p-2 mx-2">
                                                <img src="images/download_icon.png" alt="Download" class="icon-image icon-responsive">
                                            </button>
